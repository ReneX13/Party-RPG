...
abstract class Account implements ActiveRecordInterface
{
    ...
    /**
     * The value for the inventory_size field.
     *
     * Note: this column has a database default value of: 0
     * @var        int
     */
    protected $inventory_size;
    ...
    /**
     * Get the [inventory_size] column value.
     *
     * @return int
     */
    ...
    public function setLastActive($v)
    {
        ...
        if ($this->last_active !== null || $dt !== null) {
            if ($this->last_active === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_active->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AccountTableMap::COL_LAST_ACTIVE] = true;
            }
    ...
    public function setGuildId($v)
    {
        ...
        if ($this->guild_id !== $v) {
            $this->guild_id = $v;
            $this->modifiedColumns[AccountTableMap::COL_GUILD_ID] = true;
        }
    ...
    /**
     * Set the value of [inventory_size] column.
     *
     * @param int $v new value
     * @return $this|\Account The current object (for fluent API support)
     */
    public function setInventorySize($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->inventory_size !== $v) {
            $this->inventory_size = $v;
            $this->modifiedColumns[AccountTableMap::COL_INVENTORY_SIZE] = true;
        }
    ...
    public function setGold($v)
    {
        ...
        if ($this->gold !== $v) {
            $this->gold = $v;
            $this->modifiedColumns[AccountTableMap::COL_GOLD] = true;
        }
    ...
    public function setExperience($v)
    {
        ...
        if ($this->experience !== $v) {
            $this->experience = $v;
            $this->modifiedColumns[AccountTableMap::COL_EXPERIENCE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AccountTableMap::translateFieldName('LastActive', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->last_active = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AccountTableMap::translateFieldName('GuildId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->guild_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AccountTableMap::translateFieldName('InventorySize', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inventory_size = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AccountTableMap::translateFieldName('Gold', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gold = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AccountTableMap::translateFieldName('Experience', TableMap::TYPE_PHPNAME, $indexType)];
            $this->experience = (null !== $col) ? (int) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_LAST_ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = 'last_active';
        }
        if ($this->isColumnModified(AccountTableMap::COL_GUILD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'guild_id';
        }
        if ($this->isColumnModified(AccountTableMap::COL_INVENTORY_SIZE)) {
            $modifiedColumns[':p' . $index++]  = 'inventory_size';
        }
        if ($this->isColumnModified(AccountTableMap::COL_GOLD)) {
            $modifiedColumns[':p' . $index++]  = 'gold';
        }
        if ($this->isColumnModified(AccountTableMap::COL_EXPERIENCE)) {
            $modifiedColumns[':p' . $index++]  = 'experience';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'guild_id':
                        ...
                        break;
                    case 'inventory_size':
                        $stmt->bindValue($identifier, $this->inventory_size, PDO::PARAM_INT);
                        break;
                    case 'gold':
                        $stmt->bindValue($identifier, $this->gold, PDO::PARAM_INT);
                        break;
                    case 'experience':
                        $stmt->bindValue($identifier, $this->experience, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getLastActive(),
            $keys[4] => $this->getGuildId(),
            $keys[5] => $this->getInventorySize(),
            $keys[6] => $this->getGold(),
            $keys[7] => $this->getExperience(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setLastActive($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setGuildId($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setInventorySize($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setGold($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setExperience($arr[$keys[7]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_LAST_ACTIVE)) {
            $criteria->add(AccountTableMap::COL_LAST_ACTIVE, $this->last_active);
        }
        if ($this->isColumnModified(AccountTableMap::COL_GUILD_ID)) {
            $criteria->add(AccountTableMap::COL_GUILD_ID, $this->guild_id);
        }
        if ($this->isColumnModified(AccountTableMap::COL_INVENTORY_SIZE)) {
            $criteria->add(AccountTableMap::COL_INVENTORY_SIZE, $this->inventory_size);
        }
        if ($this->isColumnModified(AccountTableMap::COL_GOLD)) {
            $criteria->add(AccountTableMap::COL_GOLD, $this->gold);
        }
        if ($this->isColumnModified(AccountTableMap::COL_EXPERIENCE)) {
            $criteria->add(AccountTableMap::COL_EXPERIENCE, $this->experience);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setInventorySize($this->getInventorySize());
        $copyObj->setGold($this->getGold());
        $copyObj->setExperience($this->getExperience());
        if ($makeNew) {
            $copyObj->setNew(true);
