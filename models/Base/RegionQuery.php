 ...
 * @method     ChildRegionQuery orderByMapId($order = Criteria::ASC) Order by the map_id column
 * @method     ChildRegionQuery orderByLevel($order = Criteria::ASC) Order by the level column
 * @method     ChildRegionQuery orderByDescription($order = Criteria::ASC) Order by the description column
 *
 * @method     ChildRegionQuery groupById() Group by the id column
 * @method     ChildRegionQuery groupByMapId() Group by the map_id column
 * @method     ChildRegionQuery groupByLevel() Group by the level column
 * @method     ChildRegionQuery groupByDescription() Group by the description column
 *
 ...
 * @method     ChildRegion findOneByMapId(int $map_id) Return the first ChildRegion filtered by the map_id column
 * @method     ChildRegion findOneByLevel(int $level) Return the first ChildRegion filtered by the level column
 * @method     ChildRegion findOneByDescription(string $description) Return the first ChildRegion filtered by the description column *
 ...
 * @method     ChildRegion requireOneByMapId(int $map_id) Return the first ChildRegion filtered by the map_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildRegion requireOneByLevel(int $level) Return the first ChildRegion filtered by the level column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildRegion requireOneByDescription(string $description) Return the first ChildRegion filtered by the description column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildRegion[]|ObjectCollection findByMapId(int $map_id) Return ChildRegion objects filtered by the map_id column
 * @method     ChildRegion[]|ObjectCollection findByLevel(int $level) Return ChildRegion objects filtered by the level column
 * @method     ChildRegion[]|ObjectCollection findByDescription(string $description) Return ChildRegion objects filtered by the description column
...
abstract class RegionQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, map_id, level, description FROM Region WHERE id = :p0';
        try {
    ...
    public function filterByMapId($mapId = null, $comparison = null)
    {
        if (is_array($mapId)) {
            $useMinMax = false;
            if (isset($mapId['min'])) {
                $this->addUsingAlias(RegionTableMap::COL_MAP_ID, $mapId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($mapId['max'])) {
                $this->addUsingAlias(RegionTableMap::COL_MAP_ID, $mapId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionTableMap::COL_MAP_ID, $mapId, $comparison);
    }
    ...
    public function filterByLevel($level = null, $comparison = null)
    {
        if (is_array($level)) {
            $useMinMax = false;
            if (isset($level['min'])) {
                $this->addUsingAlias(RegionTableMap::COL_LEVEL, $level['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($level['max'])) {
                $this->addUsingAlias(RegionTableMap::COL_LEVEL, $level['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionTableMap::COL_LEVEL, $level, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RegionTableMap::COL_DESCRIPTION, $description, $comparison);
    }
