...
abstract class Element implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ElementTableMap';
    ...
    /**
     * The value for the weakness field.
     *
     * @var        int
     */
    protected $weakness;
    ...
    /**
     * The value for the strong_against field.
     *
     * @var        int
     */
    protected $strong_against;
    ...
    /**
     * Get the [strong_against] column value.
     *
     * @return int
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ElementTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Set the value of [weakness] column.
     *
     * @param int $v new value
     * @return $this|\Element The current object (for fluent API support)
     */
    public function setWeakness($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->weakness !== $v) {
            $this->weakness = $v;
            $this->modifiedColumns[ElementTableMap::COL_WEAKNESS] = true;
        }
    ...
    /**
     * Set the value of [strong_against] column.
     *
     * @param int $v new value
     * @return $this|\Element The current object (for fluent API support)
     */
    public function setStrongAgainst($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->strong_against !== $v) {
            $this->strong_against = $v;
            $this->modifiedColumns[ElementTableMap::COL_STRONG_AGAINST] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ElementTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ElementTableMap::translateFieldName('Weakness', TableMap::TYPE_PHPNAME, $indexType)];
            $this->weakness = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ElementTableMap::translateFieldName('StrongAgainst', TableMap::TYPE_PHPNAME, $indexType)];
            $this->strong_against = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = ElementTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ElementTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ElementTableMap::COL_WEAKNESS)) {
            $modifiedColumns[':p' . $index++]  = 'weakness';
        }
        if ($this->isColumnModified(ElementTableMap::COL_STRONG_AGAINST)) {
            $modifiedColumns[':p' . $index++]  = 'strong_against';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'weakness':
                        $stmt->bindValue($identifier, $this->weakness, PDO::PARAM_INT);
                        break;
                    case 'strong_against':
                        $stmt->bindValue($identifier, $this->strong_against, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getWeakness(),
            $keys[3] => $this->getStrongAgainst(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setWeakness($value);
                break;
            case 3:
                $this->setStrongAgainst($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setWeakness($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setStrongAgainst($arr[$keys[3]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ElementTableMap::COL_NAME)) {
            $criteria->add(ElementTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ElementTableMap::COL_WEAKNESS)) {
            $criteria->add(ElementTableMap::COL_WEAKNESS, $this->weakness);
        }
        if ($this->isColumnModified(ElementTableMap::COL_STRONG_AGAINST)) {
            $criteria->add(ElementTableMap::COL_STRONG_AGAINST, $this->strong_against);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setWeakness($this->getWeakness());
        $copyObj->setStrongAgainst($this->getStrongAgainst());
        if ($makeNew) {
            $copyObj->setNew(true);
        }
    }
