...
abstract class Region implements ActiveRecordInterface
{
    ...
    public function setMapId($v)
    {
        ...
        if ($this->map_id !== $v) {
            $this->map_id = $v;
            $this->modifiedColumns[RegionTableMap::COL_MAP_ID] = true;
        }
    ...
    public function setLevel($v)
    {
        ...
        if ($this->level !== $v) {
            $this->level = $v;
            $this->modifiedColumns[RegionTableMap::COL_LEVEL] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[RegionTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RegionTableMap::translateFieldName('MapId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->map_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RegionTableMap::translateFieldName('Level', TableMap::TYPE_PHPNAME, $indexType)];
            $this->level = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RegionTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = RegionTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RegionTableMap::COL_MAP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'map_id';
        }
        if ($this->isColumnModified(RegionTableMap::COL_LEVEL)) {
            $modifiedColumns[':p' . $index++]  = 'level';
        }
        if ($this->isColumnModified(RegionTableMap::COL_DESCRIPTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RegionTableMap::COL_MAP_ID)) {
            $criteria->add(RegionTableMap::COL_MAP_ID, $this->map_id);
        }
        if ($this->isColumnModified(RegionTableMap::COL_LEVEL)) {
            $criteria->add(RegionTableMap::COL_LEVEL, $this->level);
        }
        if ($this->isColumnModified(RegionTableMap::COL_DESCRIPTION)) {
            $criteria->add(RegionTableMap::COL_DESCRIPTION, $this->description);
        }
