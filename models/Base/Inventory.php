...
abstract class Inventory implements ActiveRecordInterface
{
    ...
    public function setAccountId($v)
    {
        ...
        if ($this->account_id !== $v) {
            $this->account_id = $v;
            $this->modifiedColumns[InventoryTableMap::COL_ACCOUNT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InventoryTableMap::translateFieldName('AccountId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->account_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InventoryTableMap::translateFieldName('ItemId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = InventoryTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InventoryTableMap::COL_ACCOUNT_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InventoryTableMap::COL_ACCOUNT_ID)) {
            $criteria->add(InventoryTableMap::COL_ACCOUNT_ID, $this->account_id);
        }
        if ($this->isColumnModified(InventoryTableMap::COL_ITEM_ID)) {
