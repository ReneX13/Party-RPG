...
class MapTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.MapTableMap';
     ...
     */
    const COL_DESCRIPTION = 'Map.description';

    /**
     * the column name for the image_file field
     */
    const COL_IMAGE_FILE = 'Map.image_file';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Description', 'ImageFile', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'description', 'imageFile', ),
        self::TYPE_COLNAME       => array(MapTableMap::COL_ID, MapTableMap::COL_NAME, MapTableMap::COL_DESCRIPTION, MapTableMap::COL_IMAGE_FILE, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'description', 'image_file', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Description' => 2, 'ImageFile' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'imageFile' => 3, ),
        self::TYPE_COLNAME       => array(MapTableMap::COL_ID => 0, MapTableMap::COL_NAME => 1, MapTableMap::COL_DESCRIPTION => 2, MapTableMap::COL_IMAGE_FILE => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'image_file' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('image_file', 'ImageFile', 'VARCHAR', true, 128, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MapTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(MapTableMap::COL_IMAGE_FILE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Map) { // it's a model object
