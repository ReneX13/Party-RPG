...
class ElementTableMap extends TableMap
{
     ...
     */
    const COL_NAME = 'Element.name';

    /**
     * the column name for the weakness field
     */
    const COL_WEAKNESS = 'Element.weakness';

    /**
     * the column name for the strong_against field
     */
    const COL_STRONG_AGAINST = 'Element.strong_against';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Weakness', 'StrongAgainst', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'weakness', 'strongAgainst', ),
        self::TYPE_COLNAME       => array(ElementTableMap::COL_ID, ElementTableMap::COL_NAME, ElementTableMap::COL_WEAKNESS, ElementTableMap::COL_STRONG_AGAINST, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'weakness', 'strong_against', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Weakness' => 2, 'StrongAgainst' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'weakness' => 2, 'strongAgainst' => 3, ),
        self::TYPE_COLNAME       => array(ElementTableMap::COL_ID => 0, ElementTableMap::COL_NAME => 1, ElementTableMap::COL_WEAKNESS => 2, ElementTableMap::COL_STRONG_AGAINST => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'weakness' => 2, 'strong_against' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('weakness', 'Weakness', 'INTEGER', true, null, null);
        $this->addColumn('strong_against', 'StrongAgainst', 'INTEGER', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ElementTableMap::COL_NAME);
            $criteria->addSelectColumn(ElementTableMap::COL_WEAKNESS);
            $criteria->addSelectColumn(ElementTableMap::COL_STRONG_AGAINST);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.weakness');
            $criteria->addSelectColumn($alias . '.strong_against');
        }
    }
