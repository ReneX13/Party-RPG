...
class InventoryTableMap extends TableMap
{
     ...
     */
    const COL_ACCOUNT_ID = 'Inventory.account_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('AccountId', 'ItemId', ),
        self::TYPE_CAMELNAME     => array('accountId', 'itemId', ),
        self::TYPE_COLNAME       => array(InventoryTableMap::COL_ACCOUNT_ID, InventoryTableMap::COL_ITEM_ID, ),
        self::TYPE_FIELDNAME     => array('account_id', 'item_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('AccountId' => 0, 'ItemId' => 1, ),
        self::TYPE_CAMELNAME     => array('accountId' => 0, 'itemId' => 1, ),
        self::TYPE_COLNAME       => array(InventoryTableMap::COL_ACCOUNT_ID => 0, InventoryTableMap::COL_ITEM_ID => 1, ),
        self::TYPE_FIELDNAME     => array('account_id' => 0, 'item_id' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(InventoryTableMap::COL_ACCOUNT_ID);
